...
```javascript
import iterReplicateBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-replicate-by@v0.1.0-esm/index.mjs';
```
...
[@stdlib/iter/replicate]: https://github.com/stdlib-js/iter-replicate/tree/esm
